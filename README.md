# JFrivas - Agencia Digital 🚀

![Versión](https://img.shields.io/badge/version-1.0.0-blue)
![Licencia](https://img.shields.io/badge/license-MIT-green)
![Tecnologías](https://img.shields.io/badge/tech-HTML5%20%7C%20CSS3%20%7C%20JS-orange)
![Responsive](https://img.shields.io/badge/responsive-SI-brightgreen)

**JFrivas** es una landing page de alto impacto diseñada para agencias de soluciones digitales. El proyecto combina una estética profesional con una experiencia de usuario fluida, destacando servicios de diseño, desarrollo web y marketing digital.
...
pagina-web-JFrivas/
├── CSS/
│   └── estilos.css      # Estilos globales, variables y responsive design
├── js/
│   └── main.js          # Lógica de navegación y eventos de usuario
├── img/                 # Directorio de recursos gráficos (SVG/IMG)
│   ├── logo-JFrivas.svg
